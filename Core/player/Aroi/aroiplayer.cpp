...
static ResPrototypeStotage s_aroiResourses[] =
{
	...
	// BUILDING TYPE   lvl		 RES TYPE	   VALUE(N.S)		MAX VALUE		  HARD LIM		SIZE OF GROUP		PRODECED BY		GROUP PROD.	  COMPL.	 PROGRESS(N.S)	   MATERIAL	   MAT. COST	NATURAL	    REQUARED	 CONSUME   HARD REQ.   IMPORT	IMP. LIMIT	   EXPORT	EXP. LIMIT	   DISPLAY
	{	t_AROI_HIVE,	0,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_0,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	1,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_1,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	2,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_2,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	3,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_3,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	4,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_4,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	5,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_5,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	6,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_6,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	7,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_7,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	8,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_8,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	9,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_9,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
	{	t_AROI_HIVE,	10,		{SUPPLY,		NOT_SET,	AROI_HIVE_SUP_LIM_10,	false,		GROUP_FROM_4,		POPULATION,			21,			1,			NOT_SET,		FERTILITY,	1,			true,		NO_RES,		 NOT_SET,	NOT_SET,	true,	PERCENT_25,		false,	NOT_SET,		true}},
